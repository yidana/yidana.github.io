...
$(document).ready(function () {
    var $chk = $('input[type="checkbox"][name = "regional-rel-aff-checkbox"]');
    var $tbl = $("#regional-religiousAffiliation-table");
    var $tblhead = $("#regional-religiousAffiliation-table th");
